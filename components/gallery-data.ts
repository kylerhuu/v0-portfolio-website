...
export const GALLERIES: Gallery[] = [
  {
    ...
    photos: [
      ...
      {src: "/gallery/scioly/Sciolympics_516_group_photo.jpg",title: "Drone Photo",description: "made it just in time for this photo! can we appreciate the diversity though!"},
    ],
  },

  {
    ...
    photos: [
        ...
        {src: "/gallery/ART/ Kyler Hu - SIP 1.jpg",title: "SIP #1", description: "This was my first piece. it was not the greatest, but I aim to show this to accurately display my artistic journey throughout the year because it can only go up from here! it has wabisabi"},
        {src: "/gallery/ART/ Kyler Hu - SIP 3.jpg", title: "SIP #2", description: "Started to develop my personal goal and foundation of my portfolio, started to delve into feelings of pain, isolation, and hatred."},
        {src: "/gallery/ART/ Kyler Hu - SIP 2.jpg", title: "SIP #3", description: "driven by the feelings of constantly drowning under pressure and falling closer to fire. Wanted to literally depict the contrast between the pains of self-induced pressure (water) and external pressure (fire)."},
        {src: "/gallery/ART/ Kyler Hu - SIP 9.jpg", title: "Life's Looking Glass", description: "first piece where I exlored multi-media art, implementing photography, digital art, and editing softwares. wanted to depict the difference between one's life experiences and how other's perceive your experiences."},
        {src: "/gallery/ART/ Kyler Hu - SIP 10.jpg", title: "Beauty in Isolation", description: "I am actually proud of this one. Illustrating isolation in a beautiful stance, forefronting indivdiduality not as a social loss but as a place of strength and confidence."},
        {src: "/gallery/ART/ Kyler Hu - SIP 11.jpg", title: "Fallen Angel", description: "when one loses the thing they idolize most about themselves, they often fall into a place of isolation and self-depreciative mindspaces, fully disregarding other successes in their lives."},
        {src: "/gallery/ART/ Kyler Hu - SIP 12.jpg", title: "Reality vs. Delusion", description: "this took me 30 minutes and I had a spontaneous spark to illustrate how the \"delusion\" of having wings can drive someone to insanity when in reality, they were only self-imposed hence the blurred lines."},
        {src: "/gallery/ART/ Kyler Hu - SIP 13.jpg", title: "Cultural Pressure", description: "wanted to depict \"asian parent\" stereotypes in a public way. feels like everyone is against you and your strength is a vaguely luminating bubble within your surroundings."},
        {src: "/gallery/ART/ Kyler Hu - SIP 15.jpg", title: "Closing Legacy", description: "in the last hour and moments of your life, do you wanna be thinking about all the things you could've done. hot take: we need to be a lil more selfish and focus on doing what's best for us rather than prioritizing others over yourself."},
    ]
  },
  {
    id: "thennow",
